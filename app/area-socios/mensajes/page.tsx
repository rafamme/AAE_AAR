...
type Thread = { id:string; subject:string|null; created_at:string };
...
export default async function MessagesPage() {
  ...
  const [{ data: threads }, { data: participants }, { data: messages }, { data: directory }] = await Promise.all([
    supabase.from('message_threads').select('id,subject,created_at').order('created_at', { ascending:false }),
