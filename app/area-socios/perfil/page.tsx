...
import { getBetaAwareActor } from '../../../lib/beta-access';

export default async function ProfilePage({searchParams}:{searchParams:Promise<{mensaje?:string}>}) {
  const { supabase, user, isBetaActor } = await getBetaAwareActor();
